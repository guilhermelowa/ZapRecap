...
import bskyLogo from '../assets/bsky_logo.png';
...
const ResultsPage = () => {
  ...
  const shareMessage = t('results.shareMessage', 'Check out my conversation analysis on ZapRecap! 📊 Discover fascinating insights about communication patterns.');
  const shareUrl = 'https://zap-recap-ffe516b006a4.herokuapp.com/';
  ...
  const handleBskyShare = () => {
    const bskyUrl = `https://bsky.app/intent/compose?text=${encodeURIComponent(`${shareMessage} ${shareUrl}`)}`;
